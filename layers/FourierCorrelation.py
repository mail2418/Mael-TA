...
class FourierBlock(nn.Module):
    ...
    def compl_mul1d(self, input, weights):
        ...
        return torch.einsum("bhi,hio->bho", input, weights) # 32x8x64, 8x64x64 => 32x8x64
                                                            #  BxHxI , HxI x O => B xHx O

    def forward(self, q, k, v, mask, tau, delta):
        # size = [B, L, H, E]
        B, L, H, E = q.shape # 32 x 96 x 8 x 64
        x = q.permute(0, 2, 3, 1) # Awalnya 32x96x8x64
