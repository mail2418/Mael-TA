...
# from models.ns_Transformer import Model as NSTransformer
# import numpy as np

# class Model(nn.Module):
#     def __init__(self, configs):
#         super(Model,self).__init__()
#         self.name = "NSTransformerB1"
#         self.num_models = configs.n_learner
#         self.models = nn.ModuleList([NSTransformer(configs).float() for _ in range(self.num_models)])
