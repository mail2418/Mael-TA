...
parser.add_argument('--model_id', type=str, default='MaelNetB1_MaelNetS1_SWaT_Negative_Corr_RL_2', help='model id')
...
parser.add_argument('--dec_in', type=int, default=51, help='decoder input size')
parser.add_argument('--c_out', type=int, default=51, help='output size')
parser.add_argument('--d_model', type=int, default=51, help='dimension of model')
