...
# import numpy as np
# from data_provider.rl_factory import data_provider
...
#         return agent
#     def _get_data(self,setting,flag="train"):
#         data_set, data_loader = data_provider(self.args,setting,flag)
...
#         train_dataset, train_loader = self._get_data(setting, flag="train")
#         vali_dataset, vali_loader = self._get_data(setting, flag="valid")
#         test_dataset, test_loader = self._get_data(setting, flag="test")

#         train_X = train_dataset.train_X
#         train_error = train_dataset.train_error
#         valid_X = vali_dataset.valid_X
#         test_X = test_dataset.test_X
#         train_preds = train_dataset.train_preds
#         train_y = train_dataset.train_y

#         L = len(train_X) - 1 if self.args.use_td else len(train_X)

#         obs_dim = train_X.shape[1] # Mengambil Feature
