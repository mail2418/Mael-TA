...
# from utils.tools import get_filter
...
#             dq, sq = Ud_q[i], Us_q[i]
#             dv, sv = Ud_v[i], Us_v[i]
#             Ud += [self.attn1(dq[0], dk[0], dv[0], mask, tau, delta)[0] + self.attn2(dq[1], dk[1], dv[1], mask,tau, delta)[0]]
#             Us += [self.attn3(sq, sk, sv, mask, tau, delta)[0]]
#         v = self.attn4(q, k, v, mask, tau, delta)[0]
